...
const Profile = props => {
    ...
    const fetchNameSurname = async () => {
      try {
        const response = await fetch(
          'https://n2-mobile-2dbf3-default-rtdb.firebaseio.com/user.json',
        );
  ...
  const handleChangeNameSurname = () => {
    authActions.changeNameSurname(myName, mySurName);
  };
  ...
  return (
    <ScrollView style={styles.mainContainer}>
      <View style={styles.avatarContainer}>
        ...
        <Text style={styles.nameSurname}>{profile.myName} {profile.mySurName}</Text>
        <Text style={styles.email}>email gelcek</Text>
      </View>
