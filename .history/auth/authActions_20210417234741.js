...
export const changePassword = async (
  ...
  const respChangePassword = await fetch(
    'https://securetoken.googleapis.com/v1/token?key=AIzaSyAsH-2yfH8ZXJIYulTeE7mSi9i21l18PS0',
    {
      method: 'POST',
      headers: {
        'Content-type': 'application/json',
  ...
  const respChangePasswordData = await respChangePassword.json();
  console.log(respChangePasswordData);
