...
const Profile = props => {
  ...
  // const fetchNameSurname = async (storage) => {
  ...
  const fetchStorageData = async () => {
    ...
    try {
      const response = await fetch(
        `https://n2-mobile-2dbf3-default-rtdb.firebaseio.com/${transformedData.userId}/user.json`,
      );
  ...
  return (
    <ScrollView
      ...
      <TouchableHighlight
        ...
        <Text style={{color: 'white',fontFamily:'DidactGothic-Regular'}}>SIGN OUT</Text>
      </TouchableHighlight>
    </ScrollView>
  );
};
